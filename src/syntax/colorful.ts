...
export function getColorfulSyntax(palette: Palette, italicComments: boolean) {
  const syntax = [
    // Syntax{{{
    {
      name: "String",
      scope:
        "string, punctuation.definition.string.end, punctuation.definition.string.begin",
      settings: {
    ...
    },
    {
      name: "Preproc",
      scope:
        "keyword.control.at-rule, keyword.control.import, keyword.control.export, storage.type.namespace, punctuation.decorator, keyword.control.directive.include, keyword.preprocessor, punctuation.definition.preprocessor",
      settings: {
    ...
    },
    {
      name: "Property",
      scope:
        "support.variable.property, variable.other.property, meta.object-literal.key, variable.other.object.property, variable.other.constant.property",
      settings: {
        foreground: palette.aqua,
      },
    },
    ...
    },
    {
      ...
      scope:
        "entity.name.directive.restructuredtext, markup.raw.restructuredtext, markup.raw.inner.restructuredtext",
      settings: {
        foreground: palette.green,
      },
    },
    ...
    },
    {
      name: "LaTex green",
      scope:
        "support.function.general.tex, support.class.math.block.environment.latex",
      settings: {
        foreground: palette.green,
      },
    },
    ...
    },
    {
      name: "LaTex orange",
      scope:
        "support.function.be.latex, keyword.control.equation.newline.latex",
      settings: {
        foreground: palette.orange,
      },
    },
    ...
    },
    {
      name: "Html delimiter",
      scope:
        "punctuation.definition.tag.begin.html, punctuation.definition.tag.end.html, punctuation.definition.tag.xml",
      settings: {
        foreground: palette.grey1,
      },
    },
    ...
    // CSS{{{
    {
      name: "CSS white",
      scope:
        "punctuation.section.function.begin.bracket.round.css, punctuation.section.function.end.bracket.round.css, punctuation.separator.list.comma.css",
      settings: {
        foreground: palette.fg,
      },
    },
    ...
    },
    {
      ...
      scope:
        "punctuation.quasi.element.begin.js, punctuation.quasi.element.end.js",
      settings: {
        foreground: palette.yellow,
      },
    },
    ...
    },
    {
      ...
      scope:
        "variable.language.this.js, storage.type.function.arrow.js, variable.other.object.js, constant.other.label.js",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      name: "JSX purple",
      scope:
        "constant.language.null.js.jsx, constant.language.undefined.js.jsx, constant.language.nan.js.jsx, constant.language.infinity.js.jsx",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      ...
      scope:
        "punctuation.definition.template-expression.end.ts, punctuation.definition.template-expression.begin.ts, variable.parameter.ts, variable.other.readwrite.alias.ts",
      settings: {
        foreground: palette.aqua,
      },
    },
    {
      ...
      scope:
        "keyword.operator.spread.ts, variable.language.this.ts, storage.type.function.arrow.ts, variable.other.object.ts",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      name: "TSX aqua",
      scope:
        "punctuation.definition.template-expression.end.tsx, variable.other.readwrite.alias.tsx, punctuation.definition.template-expression.begin.tsx, variable.parameter.tsx, constant.language.import-export-all.tsx, entity.other.attribute-name.tsx",
      settings: {
        foreground: palette.aqua,
      },
    },
    {
      name: "TSX purple",
      scope:
        "keyword.operator.spread.tsx, variable.language.this.tsx, storage.type.function.arrow.tsx, variable.other.object.tsx",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      name: "VUE orange",
      scope:
        "entity.name.tag.other.html, entity.name.tag.block.any.html, entity.name.tag.script.html, entity.name.tag.inline.any.html, entity.name.tag.structure.any.html, entity.name.tag.style.html, entity.name.tag.doctype.html",
      settings: {
        foreground: palette.orange,
      },
    },
    {
      name: "VUE aqua",
      scope:
        "meta.tag.other.html, meta.tag.inline.any.html, meta.tag.block.any.html",
      settings: {
        foreground: palette.aqua,
      },
    },
    ...
    // CoffeeScript{{{
    {
      ...
      scope:
        "punctuation.definition.arguments.end.bracket.round.coffee, punctuation.definition.arguments.begin.bracket.round.coffee, punctuation.definition.array.begin.bracket.square.coffee, punctuation.definition.array.end.bracket.square.coffee, punctuation.definition.character-class.regexp",
      settings: {
        foreground: palette.fg,
      },
    },
    ...
    },
    {
      ...
      scope:
        "variable.parameter.function.coffee, punctuation.section.embedded.coffee, meta.arguments.coffee, constant.character.character-class.regexp",
      settings: {
        foreground: palette.aqua,
      },
    },
    ...
    },
    {
      ...
      scope:
        "keyword.operator.slice.exclusive.coffee, keyword.operator.splat.coffee, variable.language.this.coffee, variable.other.readwrite.instance.coffee, variable.parameter.function.readwrite.instance.coffee, keyword.control.anchor.regexp, variable.other.object.coffee",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      name: "Dart purple",
      scope:
        "keyword.operator.closure.dart, storage.type.annotation.dart, keyword.other.import.dart",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      name: "Pug aqua",
      scope:
        "entity.other.attribute-name.tag.pug, variable.control.import.include.pug",
      settings: {
        foreground: palette.aqua,
      },
    },
    ...
    },
    {
      name: "Python aqua",
      scope:
        "storage.type.imaginary.number.python, support.function.magic.python, entity.name.function.python, constant.character.format.placeholder.other.python, constant.language.python, meta.member.access.python",
      settings: {
        foreground: palette.aqua,
      },
    },
    ...
    },
    {
      name: "Python purple",
      scope:
        "variable.language.special.self.python, punctuation.definition.decorator.python",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      name: "Java yellow",
      scope:
        "storage.type.primitive.java, storage.type.object.array.java, storage.type.java, storage.type.generic.java",
      settings: {
        foreground: palette.yellow,
      },
    },
    {
      name: "Java aqua",
      scope:
        "variable.other.object.property.java, storage.modifier.import.java, storage.modifier.package.java, constant.other.enum.java",
      settings: {
        foreground: palette.aqua,
      },
    },
    {
      name: "Java purple",
      scope:
        "variable.other.object.java, variable.language.this.java, keyword.other.import.java, keyword.other.package.java, punctuation.definition.annotation.java, storage.type.annotation.java",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      name: "Kotlin aqua",
      scope:
        "punctuation.section.block.begin.kotlin, punctuation.section.block.end.kotlin, punctuation.definition.keyword.kotlin, constant.language.kotlin, entity.name.function.constructor, entity.name.package.kotlin",
      settings: {
        foreground: palette.aqua,
      },
    },
    ...
    },
    {
      name: "C yellow",
      scope:
        "storage.type.built-in.primitive.c, constant.other.placeholder.c, storage.type.primitive.cpp, storage.type.built-in.primitive.cpp, storage.type.built-in.cpp, storage.type.integral.uint8_t.cpp, storage.type.integral.uint16_t.cpp, storage.type.integral.uint32_t.cpp, storage.type.integral.uint64_t.cpp",
      settings: {
        foreground: palette.yellow,
      },
    },
    {
      name: "C aqua",
      scope:
        "constant.character.escape.c, constant.language.c, variable.other.member.c, entity.name.type.namespace.cpp, constant.language.nullptr.cpp, entity.name.namespace.cpp",
      settings: {
        foreground: palette.aqua,
      },
    },
    {
      name: "C blue",
      scope:
        "meta.function-call.c, meta.conditional.switch.c, meta.bracket.square.access.c",
      settings: {
        foreground: palette.blue,
      },
    },
    {
      name: "C purple",
      scope:
        "punctuation.definition.directive.c, keyword.control.directive.define.c, keyword.control.default.c, keyword.operator.ternary.c, punctuation.definition.directive.cpp, entity.name.type.namespace.scope-resolution.cpp, constant.language.true.cpp, constant.language.false.cpp, keyword.control.default.cpp, storage.type.enum.c, entity.name.scope-resolution.cpp, entity.name.scope-resolution.function.call.cpp, entity.name.scope-resolution.parameter.cpp, entity.name.scope-resolution.function.definition.cpp, entity.name.scope-resolution.operator.cpp",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      ...
      scope:
        "keyword.control.case.objc, punctuation.definition.storage.modifier.objc",
      settings: {
        foreground: palette.orange,
      },
    },
    {
      ...
      scope:
        "storage.type.built-in.primitive.objc, constant.other.placeholder.objc",
      settings: {
        foreground: palette.yellow,
      },
    },
    ...
    },
    {
      ...
      scope:
        "entity.name.tag.pragma-mark.objc, constant.language.objc, keyword.other.property.attribute.objc, variable.other.member.objc",
      settings: {
        foreground: palette.aqua,
      },
    },
    ...
    },
    {
      ...
      scope:
        "punctuation.definition.directive.objc, keyword.control.directive.pragma.pragma-mark.objc, keyword.control.directive.import.objc, keyword.control.default.objc",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      name: "C# aqua",
      scope:
        "variable.other.object.property.cs, entity.name.variable.property.cs, entity.name.type.namespace.cs, entity.name.variable.enum-member.cs, meta.preprocessor.cs",
      settings: {
        foreground: palette.aqua,
      },
    },
    {
      name: "C# blue",
      scope:
        "entity.name.variable.local.cs, entity.name.variable.parameter.cs, entity.name.variable.field.cs",
      settings: {
        foreground: palette.blue,
      },
    },
    {
      name: "C# purple",
      scope:
        "variable.other.object.cs, keyword.control.default.cs, keyword.other.this.cs, keyword.other.using.cs, punctuation.separator.hash.cs",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      name: "Go yellow",
      scope:
        "storage.type.numeric.go, storage.type.boolean.go, storage.type.string.go, storage.type.uintptr.go, storage.type.byte.go, storage.type.rune.go, constant.other.placeholder.go",
      settings: {
        foreground: palette.yellow,
      },
    },
    {
      name: "Go aqua",
      scope:
        "entity.name.package.go, entity.alias.import.go, constant.language.go, constant.character.escape.go, entity.name.function.go",
      settings: {
        foreground: palette.aqua,
      },
    },
    ...
    },
    {
      name: "Rust yellow",
      scope:
        "storage.type.core.rust, storage.class.std.rust, meta.type_params.rust, entity.name.type.rust, constant.other.placeholder.rust",
      settings: {
        foreground: palette.yellow,
      },
    },
    ...
    },
    {
      name: "Rust purple",
      scope:
        "meta.attribute.rust, keyword.operator.sigil.rust, keyword.operator.misc.rust, variable.language.self.rust",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      name: "Swift orange",
      scope:
        "keyword.other.declaration-specifier.swift, keyword.control.branch.swift",
      settings: {
        foreground: palette.orange,
      },
    },
    {
      name: "Swift aqua",
      scope:
        "punctuation.section.embedded.end.swift, punctuation.section.embedded.begin.swift, support.variable.swift, constant.language.nil.swift, entity.name.function.swift, variable.other.swift",
      settings: {
        foreground: palette.aqua,
      },
    },
    ...
    },
    {
      name: "PHP aqua",
      scope:
        "constant.language.php, constant.other.php, entity.name.type.namespace.php",
      settings: {
        foreground: palette.aqua,
      },
    },
    ...
    },
    {
      name: "PHP purple",
      scope:
        "punctuation.section.embedded.begin.php, punctuation.section.embedded.end.php, keyword.control.default.php, variable.language.this.php, keyword.other.namespace.php",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      name: "Ruby aqua",
      scope:
        "constant.other.symbol.ruby, constant.language.ruby, punctuation.section.embedded.begin.ruby, punctuation.section.embedded.end.ruby, constant.other.symbol.hashkey.ruby, variable.other.readwrite.instance.ruby, variable.other.constant.ruby",
      settings: {
        foreground: palette.aqua,
      },
    },
    {
      name: "Ruby purple",
      scope:
        "punctuation.separator.key-value, punctuation.definition.variable.ruby, variable.other.readwrite.class.ruby, entity.name.type.module.ruby",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      name: "Lua aqua",
      scope:
        "constant.language.lua, variable.other.table.property.lua, entity.name.function-table.lua",
      settings: {
        foreground: palette.aqua,
      },
    },
    ...
    // Scala{{{
    {
      name: "Scala yellow",
      scope:
        "storage.type.primitive.scala, storage.type.scala, entity.name.class.declaration, entity.name.class",
      settings: {
        foreground: palette.yellow,
      },
    },
    ...
    },
    {
      name: "Scala aqua",
      scope:
        "constant.language.scala, punctuation.definition.template-expression.begin.scala, punctuation.definition.template-expression.end.scala, entity.name.import.scala",
      settings: {
        foreground: palette.aqua,
      },
    },
    ...
    },
    {
      name: "Elixir blue",
      scope:
        "constant.other.symbol.elixir, source.elixir.embedded.source, punctuation.definition.variable.elixir",
      settings: {
        foreground: palette.blue,
      },
    },
    ...
    },
    {
      name: "Elm orange",
      scope:
        "keyword.other.elm, keyword.type-alias.elm, keyword.other.colon.elm",
      settings: {
        foreground: palette.orange,
      },
    },
    ...
    },
    {
      name: "Erlang purple",
      scope:
        "entity.name.type.class.module.definition.erlang, entity.name.type.class.module.erlang",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      name: "Groovy yellow",
      scope:
        "storage.type.groovy, storage.type.primitive.groovy, storage.type.object.array.groovy",
      settings: {
        foreground: palette.yellow,
      },
    },
    ...
    },
    {
      name: "Groovy blue",
      scope:
        "meta.definition.variable.name.groovy, meta.method-call.groovy, meta.definition.variable.groovy",
      settings: {
        foreground: palette.blue,
      },
    },
    ...
    // Fortran{{{
    {
      name: "Fortran yellow",
      scope:
        "storage.type.character.fortran, storage.type.integer.fortran, storage.type.real.fortran, storage.type.complex.fortran",
      settings: {
        foreground: palette.yellow,
      },
    },
    ...
    },
    {
      name: "Fortran purple",
      scope:
        "entity.name.program.fortran, keyword.control.default.fortran, keyword.control.result.fortran",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      name: "Lisp blue",
      scope:
        "entity.name.variable.lisp, variable.other.global.lisp, punctuation.definition.variable.lisp",
      settings: {
        foreground: palette.blue,
      },
    },
    ...
    },
    {
      name: "Shell aqua",
      scope:
        "entity.name.function.shell, string.unquoted.argument.shell, punctuation.definition.evaluation.parens.begin.shell, punctuation.definition.evaluation.parens.end.shell",
      settings: {
        foreground: palette.aqua,
      },
    },
    {
      name: "Shell blue",
      scope:
        "punctuation.definition.variable.shell, meta.argument.shell, punctuation.section.bracket.curly.variable.begin.shell, punctuation.section.bracket.curly.variable.end.shell",
      settings: {
        foreground: palette.blue,
      },
    },
    {
      name: "Shell purple",
      scope:
        "variable.other.special.shell, variable.language.special.shell, variable.parameter.positional.shell, variable.parameter.positional.all.shell, variable.other.positional.shell",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      ...
      scope:
        "keyword.other.hashtable.begin.powershell, constant.language.powershell",
      settings: {
        foreground: palette.purple,
      },
    },
    ...
    },
    {
      name: "Diff green",
      scope:
        "meta.diff.header.from-file, markup.inserted.diff, punctuation.definition.inserted.diff",
      settings: {
        foreground: palette.green,
      },
    },
    ...
    },
    {
      name: "VimL aqua",
      scope:
        "support.function.viml, constant.character.map.key.viml, constant.character.map.viml",
      settings: {
        foreground: palette.aqua,
      },
    },
    ...
    // YAML{{{
    {
      name: "YAML white",
      scope:
        "punctuation.separator.key-value.mapping.yaml, string.unquoted.plain.out.yaml",
      settings: {
        foreground: palette.fg,
      },
    },
    ...
    // TOML{{{
    {
      name: "TOML red",
      scope:
        "entity.other.attribute-name.table.toml, punctuation.definition.table.toml, meta.tag.table.toml",
      settings: {
        foreground: palette.red,
      },
    },
    ...
    },
    {
      name: "TOML aqua",
      scope:
        "constant.other.datetime-with-timezone.toml, constant.other.date.toml, constant.other.datetime.toml",
      settings: {
        foreground: palette.aqua,
      },
    },
    ...
    },
    {
      name: "TOML purple",
      scope:
        "constant.other.boolean.toml, entity.other.attribute-name.table.array.toml, punctuation.definition.table.array.toml",
      settings: {
        foreground: palette.purple,
      },
    },
